...
func _ready():
	...
	var fur_pattern = random.randi_range(1,3)
	if fur_pattern == 1:
		if color == 1:
	...
	if fur_pattern == 2:
		if color == 1:
			appearence.append("black")
		if color == 2:
			appearence.append("gray")
		if color == 3:
			appearence.append("white")
		appearence.append("full")
	if fur_pattern == 3:
		appearence.append("black")
		appearence.append("bi")
	...
	if AnimationC.sprite_frames == null:
		var happy_meal = random.randi_range(1,50)
		var needed_string
		if happy_meal == 1:
			needed_string = str("res://Scenes/Cats/catredstrp4.tres")
		elif happy_meal == 2:
			needed_string = str("res://Scenes/Cats/catredbi1.tres")
		elif happy_meal == 3:
			needed_string = str("res://Scenes/Cats/catredbi2.tres")
		else:
			needed_string = str("res://Scenes/Cats/", appearence[3],appearence[0],appearence[1],appearence[2],".tres")
...
#							else:
	...
	if cat_can_meow and current_state != 2:
		if satisfaction == 100:
			HappyMeow.play()
			if EventBus.sound == false:
				Emotion.texture = load("res://Scenes/Cats/happyness.tres")
		elif satisfaction == 50 and current_state != 2:
			AngryMeow.play()
			if EventBus.sound == false:
				Emotion.texture = load("res://Scenes/Cats/sadness.tres")
...
func _on_happy_meow_finished():
	Emotion.texture = null


func _on_angry_meow_finished():
	Emotion.texture = null
