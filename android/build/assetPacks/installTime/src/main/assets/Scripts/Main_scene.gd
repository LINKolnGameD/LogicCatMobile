...
var hidden_lonely = [6, 5, 5]
var hidden_down = [9, 5, 5]
var hidden_social = [7, 5, 5]
var hidden_warmer = [10, 5, 5]
var hidden_up = [8, 5, 5]
...
#so 0 = lonly, 1 = sociable, 2 = hieghtlover, 3 = lowlover, 4 = warmlover, 5 = nothing
	...
	if preferences_set == false:
		if level == 1:
			...
			first_cat_preferences_info.append_array([0, 3, 4])
			second_cat_preferences_info.append_array([0, 3, 4])
			...
			first_cat_preferences_info.append_array(hidden_down)
		elif level == 95:
			first_cat_preferences_info.append_array(hidden_social)
		elif level == 96:
			first_cat_preferences_info.append_array(hidden_warmer)
		elif level == 97:
			first_cat_preferences_info.append_array(social)
			second_cat_preferences_info.append_array(hidden_down)
		elif level == 98:
			first_cat_preferences_info.append_array(warmer)
			second_cat_preferences_info.append_array(hidden_up)
		elif level == 99:
			first_cat_preferences_info.append_array(warmer)
			second_cat_preferences_info.append_array(social)
			third_cat_preferences_info.append_array(hidden_social)
		elif level == 100:
			first_cat_preferences_info.append_array(lonely)
			second_cat_preferences_info.append_array(hidden_warmer)
			third_cat_preferences_info.append_array(social)
		elif level == 101:
			first_cat_preferences_info.append_array([7, 10, 5])
			second_cat_preferences_info.append_array(social)
			third_cat_preferences_info.append_array(warmer)
			fourth_cat_preferences_info.append_array(lonely)
		elif level == 102:
			first_cat_preferences_info.append_array(warmer)
			second_cat_preferences_info.append_array([6, 9, 5])
		elif level == 103:
			first_cat_preferences_info.append_array(simple)
			second_cat_preferences_info.append_array([8, 10, 5])
			third_cat_preferences_info.append_array(hidden_down)
		elif level == 104:
			first_cat_preferences_info.append_array(hidden_warmer)
			second_cat_preferences_info.append_array(hidden_warmer)
			third_cat_preferences_info.append_array([7, 10, 5])
			fourth_cat_preferences_info.append_array(simple)
		elif level == 105:
			first_cat_preferences_info.append_array([6,9,10])
			second_cat_preferences_info.append_array(warmer_up)
	...
	if furniture_set == false:
		...
		if level == 1:
			...
			Level.spawn("Bed", 10, true)
			Level.spawn("Lamp", 15, false)
			Level.spawn("ArmChair", 16, false)
		elif level == 89:
			Level.spawn("Sofa2", 2, false)
			Level.spawn("Sofa", 3, false)
			...
			Level.spawn("Puff", 1, false)
			Level.spawn("ArmChair", 3, false)
			Level.spawn("CoffeeTable", 4, false)
			Level.spawn_plug(4)
			Level.spawn("Stand", 6, false)
			Level.spawn("Candle", 6, false)
			Level.spawn("Sofa2", 13, true)
			...
			Level.spawn("Table", 5, true)
			Level.spawn_plug(9)
			Level.spawn("Lamp", 6, false)
			Level.spawn("Puff", 14, false)
			Level.spawn("ArmChair", 16, true)
		elif level == 97:
			Level.spawn("Shelf", 1, false)
			Level.spawn("Sofa2", 6, false)
			Level.spawn("Sofa", 7, false)
			...
			Level.spawn("Stand", 13, false)
			Level.spawn("Lamp", 13, false)
			Level.spawn("Sofa2", 14, false)
			Level.spawn("Sofa", 15, false)
		elif level == 98:
			Level.spawn("ArmChair", 1, false)
			Level.spawn("ChairEars", 4, false)
			Level.spawn("CoffeeTable", 7, false)
			Level.spawn("CoffeeTable", 10, false)
			Level.spawn("TV", 13, true)
		elif level == 99:
			Level.spawn("Candle", 1, false)
			Level.spawn("Sofa2", 2, false)
			Level.spawn("Sofa", 3, false)
			Level.spawn("Table", 5, true)
			Level.spawn("Table2", 9, true)
			...
			Level.spawn("Puff", 13, false)
			Level.spawn_plug(13)
			Level.spawn("Stand", 15, false)
			Level.spawn("Candle", 15, false)
			Level.spawn("CoffeeTable", 12, false)
			Level.spawn("Puff", 16, false)
		elif level == 101:
			Level.spawn("Stand", 1, false)
			Level.spawn_plug(1)
			Level.spawn("Puff", 3, false)
			Level.spawn("Puff", 4, false)
			Level.spawn("ChairEars", 6, true)
			Level.spawn("Lamp", 7, false)
			Level.spawn("ArmChair", 8, true)
			Level.spawn("Sofa", 9, true)
			Level.spawn("Sofa2", 13, true)
			Level.spawn_plug(9)
			Level.spawn("Puff", 11, false)
