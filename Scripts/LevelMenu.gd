...
#		pin_six_position.append(i.position)
#	print(pin_six_position)
#	seventy_to_90_button.clear()
#	for i in $MarginContainer2/Levels.get_children():
#		if number > 90 or number < 75:
#			number += 1
#		else:
#			print(number)
#			seventy_to_90_button.append(i.global_position)
#			number += 1
#	print(seventy_to_90_button)
#	print(Line.points)
